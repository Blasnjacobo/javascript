...
let users = {
  ...
  function isEveryoneHere(userObj) {
    let Names = [];
    let AlanKey = userObj.hasOwnProperty('Alan');
    let JeffKey = userObj.hasOwnProperty('Jeff');
    let SarahKey = userObj.hasOwnProperty('Sarah');
    let RyanKey = userObj.hasOwnProperty('Ryan');
    let final = (AlanKey && JeffKey && SarahKey && RyanKey);
    return (final)
  }
